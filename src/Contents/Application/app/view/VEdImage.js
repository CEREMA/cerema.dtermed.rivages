    ...
    initComponent: function() {
        ...
        this.bbar = [
            '->',
            {
                ...
                itemId: "PREC",
                handler: function() {
                    App.$('#EdImage').attr('src', me.itm[me.ndx-2].data.url.replace('thumbs','images'));
                    me.ndx--;
            ...
            },
            {
                ...
                itemId: "NEXT",
                handler: function() {
                    App.$('#EdImage').attr('src', me.itm[me.ndx].data.url.replace('thumbs','images'));
                    me.ndx++;
                    if (me.ndx == 1) App.get(me, 'button#PREC').setDisabled(true);
                    else App.get(me, 'button#PREC').setDisabled(false);
                    if (me.ndx == me.total) App.get(me, 'button#NEXT').setDisabled(true);
        ...
        this.tbar = [{
            ...
            },
            {
                ...
                handler: function() {
                    ...
                    me.COORDS = {};
                    var d = new Date();
                    App.$('#EdImage').attr('src', '/rotate/' + d.getTime() + '/' + me.tkid + '/' + me.filename);
            ...
            },
            {
                ...
                iconCls: "btn_blur",
                handler: function() {
                    me.crop = new Cropper(App.$('#EdImage').dom(), {
                        autoCrop: false,
                        crop: function(event) {
                            me.COORDS = [
                                event.detail.x,
                        ...
                        cropend: function() {
                            var d = new Date();
                            App.$('#EdImage').attr('src', '/blur/' + me.COORDS.join(',') + '/' + d.getTime() + '/' + me.tkid + '/' + me.filename);
                            if (me.crop) me.crop.destroy();
                        }
                    });
            ...
            '->',
            {
                ...
                handler: function() {
                    ...
                    me.COORDS = {};
                    var d = new Date();
                    App.$('#EdImage').attr('src', '/reset/' + d.getTime() + '/' + me.tkid + '/' + me.filename);
                }
            }
        ];
        this.items = [{
        ...
        this.listeners={
            ...
            "show": function(p) {
                ...
                App.$('#EdImage').attr('src', '/images/' + d.getTime() + '/' + this.tkid + '/' + this.filename);
            }
        };
